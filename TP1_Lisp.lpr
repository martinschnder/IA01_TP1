;; -*- lisp-version: "10.1 [32-bit Windows] (Jan 27, 2021 17:58)"; -*-

(in-package :cg-user)

(define-project :name :|TP1_Lisp|
  :modules (list (make-instance 'module :name "ex2") (make-instance 'module :name "ex3")
                 (make-instance 'module :name "ex4") (make-instance 'module :name "ex1"))
  :projects nil
  :libraries nil
  :editable-files nil
